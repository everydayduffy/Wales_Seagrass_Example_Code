...
files <- tools::file_path_sans_ext(list.files("Data/Classified", pattern = ".*.txt"))

results <- NULL

for(h in 1:length(files))
{
  data <- read.table(paste0("Data/Classified/",files[h],".txt"),h=T)
